...
public class SendLetterWithoutSubjectAndBodyTest {
    ...
    @Test
    public void sendLetterWithoutSubjectAndBodyTest() {
        MailService.sendLetterWithoutSubjectAndBody(letter);
        MailService.clickTheWarning();
        assertTrue(MailService.isSuccessfulSendLetter() && MailService.isLetterWithoutSubjectPresentInSent(letter));
    }
