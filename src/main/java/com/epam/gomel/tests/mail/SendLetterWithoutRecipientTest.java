...
public class SendLetterWithoutRecipientTest {
    ...
    @Test
    public void sendLetterWithoutRecipientTest() {
        MailService.sendLetterWithoutRecipient(letter);
        assertTrue(MailService.isAlertPresent());
    }
